...
INSERT INTO `my_article` (`id`, `title`, `keywords`, `desc`, `author`, `thumb`, `content`, `click`, `zan`, `rec`, `time`, `cateid`) VALUES
(6, '', '', '', '', '', '', 0, 0, 0, 0, 23),
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='权限分组表';

--
-- 转存表中的数据 `my_auth_group`
--

INSERT INTO `my_auth_group` (`id`, `title`, `status`, `rules`) VALUES
...
INSERT INTO `my_auth_rule` (`id`, `name`, `title`, `type`, `status`, `condition`, `pid`, `level`, `sort`) VALUES
...
INSERT INTO `my_cate` (`id`, `catename`, `type`, `keywords`, `desc`, `content`, `rec_index`, `rec_bottom`, `pid`, `sort`) VALUES
(25, '骑行单车', 1, '', '', '', 0, 0, 0, 50),
(26, '酷奇飞车', 1, '飞车,自行车', '飞车的栏目描述', '', 1, 0, 25, 50),
(27, '复古骑行', 1, '', '', '', 0, 1, 25, 50),
(28, '骑行装备', 1, '', '', '', 0, 0, 0, 50),
(29, '车身装备', 1, '', '', '', 0, 0, 28, 50),
(30, '人身装备', 1, '', '', '', 0, 0, 28, 50),
...
INSERT INTO `my_conf` (`id`, `cnname`, `enname`, `type`, `value`, `values`, `sort`) VALUES
(1, '站点名称', 'sitename', 1, '户外骑行', '', 53),
...
INSERT INTO `my_link` (`id`, `title`, `desc`, `url`, `sort`) VALUES
...
--
ALTER TABLE `my_admin`
  MODIFY `id` mediumint(9) NOT NULL AUTO_INCREMENT COMMENT '管理员id', AUTO_INCREMENT=30;
